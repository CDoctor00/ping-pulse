  ...
  "inline-flex items-center rounded-md border px-2.5 py-1 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success:
          "border-transparent bg-success text-success-foreground shadow hover:bg-sucess/80",
        warning:
          "border-transparent bg-warning text-warning-foreground shadow hover:bg-warning/80",
        pending:
          "border-transparent bg-pending text-pending-foreground shadow hover:bg-pending/80",
        default:
